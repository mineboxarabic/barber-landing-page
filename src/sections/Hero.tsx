...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background image with parallax-ready slow zoom */}
      <motion.div
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(22,22,22,0.65) 0%, rgba(22,22,22,0.55) 40%, rgba(22,22,22,0.92) 100%), radial-gradient(ellipse 80% 60% at 50% 100%, rgba(103,47,37,0.35) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-20 flex flex-col items-center gap-4 px-6 max-w-4xl">
        ...
        <motion.p
          {...fadeIn(0.4)}
          className="font-script text-4xl md:text-5xl text-brand-cream"
        >
          Your Neighbourhood
        </motion.p>

        {/* Shop name — scale entrance */}
        <motion.h1
          ...
          className="font-display text-7xl md:text-9xl font-bold text-brand-cream leading-none"
          style={{ letterSpacing: '0.02em', textShadow: '0 4px 24px rgba(0,0,0,0.5)' }}
        >
          The Chair
        </motion.h1>
        ...
        <motion.div {...fadeIn(1.45)} className="mt-10 flex flex-col sm:flex-row gap-4">
          <Button href="#contact" aria-label="Book a haircut appointment">
            Book a Cut
          </Button>
