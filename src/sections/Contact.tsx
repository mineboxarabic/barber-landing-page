        ...
        <div className="flex flex-col gap-8">
          ...
          <FadeUp delay={0.25}>
            <div className="flex flex-col gap-1">
              ...
              <a
                ...
                className="font-sans text-base md:text-lg text-brand-brown hover:text-brand-cream transition-colors cursor-pointer mt-2"
              >
                (416) 555-1234
              </a>
            </div>
          ...
          <FadeUp delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              <Button href="tel:+14165551234" aria-label="Call us to book an appointment">
                Call to Book
              </Button>
              <Button
                href="https://maps.google.com/?q=Queen+Street+West+Toronto"
                variant="ghost"
        ...
        <FadeUp delay={0.2}>
          <div className="relative w-full aspect-square md:aspect-[4/5] overflow-hidden border border-brand-charcoal group">
            ...
            <iframe
              ...
              className="absolute inset-0 w-full h-full grayscale brightness-[0.6] contrast-[1.1] group-hover:grayscale-0 group-hover:brightness-90 transition-all duration-700"
